...
function Pulmonologist() {
  ...
  const filterDoctorCity = doctors.filter((e) => {
    ...
    const isSpecialistPulmonologist =
      e.specialist && e.specialist.toLowerCase() === "pulmonologist";

    return matchesCityOrName && isSpecialistPulmonologist;
  });
    ...
    <>
      ...
      {filterDoctorCity.length === 0 ? (
        <p  className="text-center text-3xl font-semibold my-32">
          No Pulmonologist doctors found.
        </p>
      ) : (
...
export default HOC(Pulmonologist);
