...
function AllDrSpecialist() {
  ...
  const filterDoctorCity = doctors.filter((e) => {
    return (
      (e.fname && e.fname.toLowerCase().includes(searchDoctorCity.toLowerCase())) ||
            ...
            <div>
              ...
              <div className="flex space-x-6">
                ...
                <div className="border-x-2 px-5">
                  <h1 className="font-semibold">{e.experience} Years</h1>
...
export default HOC(AllDrSpecialist);
