...
function ChildSpecialist() {
  ...
  const filterDoctorCity = doctors.filter((e) => {
    ...
    const isChildSpecialist =
      e.specialist && e.specialist.toLowerCase() === "childSpecialist";

    return matchesCityOrName && isChildSpecialist;
  });
    ...
    <>
      ...
      {filterDoctorCity.length === 0 ? (
        <p  className="text-center text-3xl font-semibold my-32">
          No Child Specialist doctors found.
        </p>
      ) : (
...
export default HOC(ChildSpecialist)
