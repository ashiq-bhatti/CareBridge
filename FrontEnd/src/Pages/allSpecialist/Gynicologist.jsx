...
function Gynicologist() {
  ...
  const filterDoctorCity = doctors.filter((e) => {
    ...
    const isSpecialistGynecology =
      e.specialist && e.specialist.toLowerCase() === "gynicology";

    return matchesCityOrName && isSpecialistGynecology;
  });
...
export default HOC(Gynicologist);
