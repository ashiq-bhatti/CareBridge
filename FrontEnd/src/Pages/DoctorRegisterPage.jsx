  ...
  return (
    <>
      <div >
        ...
        >
          <h1 className="text-2xl text-center pb-5 font-bold">
            Registration Of Doctor
          </h1>
          <form onSubmit={handleSubmit} encType="multipart/form-data" method="post" action="/upload">
            ...
            <div id="input" className="flex flex-col md:flex-row gap-3 mt-7">
              ...
              <div className="w-full">
                ...
                >
                  ...
                  <option value="Gynicology">Gynicology</option>
                  <option value="Pulmonologist">Pulmonologist</option>
                  <option value="SkinSpecialist">SkinSpecialist</option>
                  <option value="DiabetesSpecialist">Diabetes Specialist</option>
            ...
            <div className="flex flex-col md:flex-row gap-3 mt-7 bg-slate-800 rounded text-white">            
              <input type="file" 
              name="image"
              className="w-full"
              />
